    ...
    private void initDaysInCalender(LayoutParams buttonParams, Context context, DisplayMetrics metrics) {
        ...
        for (int weekNumber = 0; weekNumber < 6; ++weekNumber) {
            for (int dayInWeek = 0; dayInWeek < 7; ++dayInWeek) {
                ...
                engDaysArrayCounter++;
                ViewTreeObserver vto = day.getViewTreeObserver();
                vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        day.setTag(R.id.x, location[0]);
                        day.setTag(R.id.y, location[1]);
                        day.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                        Log.d("CalendarTest", "X:" + x + ", Y:" + y);
                    }
                });
